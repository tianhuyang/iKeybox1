...
public:
    ...
    void MakeKey(NSString *key,char const* chain, int keylength=DEFAULT_BLOCK_SIZE, int blockSize=DEFAULT_BLOCK_SIZE);
...
public:
    ...
    void Encrypt(NSString* in,NSString **result,int iMode=ECB);
    
	void Encrypt(char const* in, char* result, size_t n, int iMode=ECB);
	
    void Decrypt(NSString* in, NSString **result,int iMode=ECB);
